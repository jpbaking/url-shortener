...
const logoMarkSvg = `<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64"><rect x="3" y="3" width="58" height="58" rx="13" fill="#12279E"/><g transform="translate(38,38) rotate(45)"><rect x="-12" y="-7" width="24" height="14" rx="7" fill="none" stroke="#D9821F" stroke-width="4"/></g><g transform="translate(26,26) rotate(45)"><rect x="-12" y="-7" width="24" height="14" rx="7" fill="#12279E"/><rect x="-12" y="-7" width="24" height="14" rx="7" fill="none" stroke="#FFFFFF" stroke-width="4"/></g></svg>`;
